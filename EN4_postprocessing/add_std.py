...
>>>>>>> refs/remotes/origin/feature/update_amm15_en4
...
<<<<<<< HEAD
fn_in = "%s%03s_mask_means_daily.nc"%(config.dn_out, season)
fn_out = "%s%03s_mask_means_daily2.nc"%(config.dn_out, season)
fn_cfg_prof = config.fn_cfg_prof

prof = coast.Profile(config=fn_cfg_prof)
prof.dataset = xr.open_dataset(fn_in, chunks={'id_dim':10000})
=======
