...
class config:
    ...
    def __init__(self):
        ...
        self.fn_cfg_nemo_u = self.get_shell_var('FN_CFG_NEMO_U', True)
        self.fn_cfg_nemo_v = self.get_shell_var('FN_CFG_NEMO_V', True)
        self.fn_cfg_nemo_f = self.get_shell_var('FN_CFG_NEMO_F', True)
