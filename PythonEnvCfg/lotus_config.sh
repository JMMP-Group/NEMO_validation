...
export DIN_EN4="/gws/ssde/j25b/class_vol2/senemo/shared/EN4/downloads/EN.4.2.2.profiles/"
export DN_ERA5="/gws/ssde/j25b/jmmp/ERA5/"
export DN_ERA_INTERIM="/gws/ssde/j25b/jmmp/ERA_interim/"
export DN_SWOT="/gws/ssde/j25b/jmmp/CO9_AMM15_validation/SWOT/"

# prefix for preprocessed EN4 data (chunked into files by region and time)
export REGION="AMM15"
# location of preprocessed EN4 data
export DOUT_EN4="/gws/ssde/j25b/class_vol2/senemo/shared/EN4/processed/"$REGION"/"

# directory for NEMO domain_cfg.nc file
export DN_DOM="/gws/ssde/j25b/jmmp/jmmp_collab/AMM15/DOMAIN_CFG/"
export DN_DAT="/gws/ssde/j25b/jmmp/MASS/"$MASS_DIR"/25hourm/"  # MOD 24h ave
export GRID="GEG_SF12.nc"

# directory for NEMO data files
#export DN_DAT="/gws/ssde/j25b/jmmp/CO9_AMM15/outputs/p0/daily/"  # Dave 25h data
if [[ $COMP_MOD = "co7" ]]; then
  export COMP_DAT="/gws/ssde/j25b/jmmp/MASS/rosie_mi-ao113_2004/25hourm/"  # MOD 24h ave
...
export DN_OUT="/gws/ssde/j25b/jmmp/CO9_AMM15_validation/"$MOD"/"
export COMP_OUT="/gws/ssde/j25b/jmmp/CO9_AMM15_validation/"$COMP_MOD"/"
