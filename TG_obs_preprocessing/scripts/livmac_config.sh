#!/bin/bash
export MACHINE="LIVMAC"  # resource on JASMIN. Already set

export CONDA_ENV="/opt/miniconda3/envs/gtm_obs_env"
...
export COAST_REPO="/Users/jelt/GitHub/COAsT"
...
export FN_OUT_DIR="/Users/jelt/Downloads/SENEMO/data/for_validation_"$GRID_OBS_RAD"_"$THIN_OBS_RAD"/obs_"
...
## Commented out as not defined for LIVMAC
